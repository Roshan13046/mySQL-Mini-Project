    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10 containingDiv">
                ...
                <?php 
                    //name ,type(length)
                    $sql = "CREATE TABLE user(ID INT(4) NOT NULL PRIMARY KEY AUTO_INCREMENT,firstname  CHAR(30) NOT NULL , lastname  CHAR(30) NOT NULL,email VARCHAR(30),password VARCHAR(40))";
